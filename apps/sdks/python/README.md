...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**v1_config_get**](docs/DefaultApi.md#v1_config_get) | **GET** /v1/config | Fetch all flag configs for an environment
*DefaultApi* | [**v1_evaluate_post**](docs/DefaultApi.md#v1_evaluate_post) | **POST** /v1/evaluate | Evaluate a feature flag


## Documentation For Models

 - [V1EvaluatePostRequest](docs/V1EvaluatePostRequest.md)
