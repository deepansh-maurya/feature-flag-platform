...
import { Body, Controller, Get, Param, ParseEnumPipe, Post, Query, Res } from '@nestjs/common';
import { Response } from 'express';
import { AuditModuleService } from '../application/use-cases/auditmodule.service';
import { AppendAuditLogDto, ListAuditLogsDto } from './dto/create-auditmodule.dto';
