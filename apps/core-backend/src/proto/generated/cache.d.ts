...
export interface ProtoGrpcType {
    cache: {
        ...
        ApiKeyUpdator: SubtypeConstructor<typeof grpc.Client, _cache_ApiKeyUpdatorClient> & {
            service: _cache_ApiKeyUpdatorDefinition;
        };
        CacheUpdater: SubtypeConstructor<typeof grpc.Client, _cache_CacheUpdaterClient> & {
            service: _cache_CacheUpdaterDefinition;
        };
        ConfiUpdator: SubtypeConstructor<typeof grpc.Client, _cache_ConfiUpdatorClient> & {
